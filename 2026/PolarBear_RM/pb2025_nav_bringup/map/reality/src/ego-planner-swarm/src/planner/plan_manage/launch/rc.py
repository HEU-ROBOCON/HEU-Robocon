...
def generate_launch_description():
    ...
    map_size_z = LaunchConfiguration('map_size_z', default=1.0)
    ...
    target_x = LaunchConfiguration('target_x', default=40.0)
    target_y = LaunchConfiguration('target_y', default=40.0)
    target_z = LaunchConfiguration('target_z', default=0.0)
