...
def generate_launch_description():
    ...
    #map_file = '/home/why/1_24/scans_full_clean.ply'
    map_file = '/home/why/PCD/sample.pcd'
    ...
    # 将原本断开的 odom 和 base_link 连起来
    static_tf_odom2baselink = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        name='odom2baselink',
