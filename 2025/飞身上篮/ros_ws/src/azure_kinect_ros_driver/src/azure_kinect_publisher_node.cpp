...
int main(int argc, char** argv) {
    ...
    nh.param<int>("device_id", device_id_param, K4A_DEVICE_DEFAULT); // 设备 ID
    ...
    config.color_format = K4A_IMAGE_FORMAT_COLOR_BGRA32; // SDK 输出 BGRA, 回调中转为 BGR
    ...
    color_cam_info_msg.D.resize(8); // K4A_CALIBRATION_LENS_DISTORTION_MODEL_RATIONAL_6 使用8个参数
    ...
    std::string depth_frame_id = "k4a_color_optical_frame"; // 深度图已对齐到彩色相机坐标系
